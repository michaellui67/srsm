...
<div class="content">
    ...
    <section class="content">
        ...
        <tr><th>Tipe</th><td>$row[class]</td></tr>
        <tr><th>Sesi</th><td>$row[seat]</td></tr>
        <tr><th>Tanggal/Waktu</th><td>" . date("D d, M Y", strtotime($row['date'])) . " / $row[time]</td></tr>
        <tr><th>Jumlah Pembayaran</th><td>$ $row[amount]</td></tr>
        <tr><th>Tanggal Pembayaran</th><td>$row[payment_date]</td></tr>
        <tr><th>Referensi Pembayaran</th><td>$row[ref]</td></tr>
        <tr><th>Acara</th><td>" . getRouteFromSchedule($row['schedule_id']) . "</td></tr>
