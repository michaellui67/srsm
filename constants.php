...
if (!function_exists('connect')) {
  ...
  function connect()
  {
    ...
    if (!$con)
      die("Database is being upgraded!");
    return $con;
  }
}
...
function getImage($id, $conn)
{
  ...
  if (strlen($row['loc']) < 10)
    return "images/trainlg.png";
  else
...
<h1 style="text-align:center"><img src="images/trainlg.png" width="100" height="100"/><br/>SISTEM RESERVASI STADION MALANG<br/> RESERVASI</h1> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+6">Ticket N<u>o</u>: $uniqueCode </font></div>
<table width="100%" border="1">
<tr><th colspan="2" style="text-align:center"><b>Personal Data</b></th></tr>
<tr><th><b>Nama:</b></th><td>$fullname</td></tr>
<tr><th><b>Email:</b></th><td>$email</td></tr>
<tr><th><b>Nomor HP:</b></th><td>$phone</td></tr>
<tr><td colspan="2" style="text-align:center"><b>Detail Acara</b></td></tr>
<tr><th><b>Acara:</b></th><td>$route</td></tr>
<tr><th><b>Fasilitas:</b></th><td>$train</td></tr>
<tr><th><b>Tipe:</b></th><td>$class Class</td></tr>
<tr><th><b>Nomor:</b></th><td>$seat</td></tr>
...
function printReport($id)
{
  ...
  if ($getCount->num_rows < 1) {
    echo "<script>alert('Error!');window.location='admin.php?page=report'</script>";
    exit;
  }
  ...
  $start = '<table class="table" width="100%" border="1"><tr><th class="a">SN</th><th  class="c">Nama</th><th  class="shrink">Kode/Tipe</th><th  class="b">Nomor</th></tr>';
  $end = '</table>';
  ...
  $pdf->setTextShadow(array('enabled' => true, 'depth_w' => 0.2, 'depth_h' => 0.2, 'color' => array(196, 196, 196), 'opacity' => 1, 'blend_mode' => 'Normal'));
  // Set some content to print
  $html = '<h5 style="text-align:center"><img src="images/trainlg.png" width="80" height="80"/><br/>SISTEM RESERVASI STADION MALANG<br/> LIST OF BOOKINGS  FOR ' . $date . ' (' . $time . ')</h5> <div style="text-align:right; font-family:courier;font-weight:bold"><font size="+1">Train ' . $train . ' (' . $sn . ' Passengers) : ' . $schedule . ' </font></div>' . $result;
  // die($html);
  // Print text using writeHTMLCell()
  $pdf->writeHTMLCell(0, 0, '', '', $html, 0, 1, 0, true, '', true);
  // ---------------------------------------------------------
